...
concommand.Add("supurge_hiz", function()
	vecf = vecf + phys:GetAngles():Forward() * self.Speed * 2
end)
...
if CLIENT then
	...
	hook.Add("HUDPaint", "broom_drawhud", function()
		local ent = LocalPlayer():GetNWEntity("broom_active")
	       ...
	       draw.SimpleText("Quaffle Sende!", "ekraniyazisi",x3,y3,quaffleyazirenk,TEXT_ALIGN_CENTER)
