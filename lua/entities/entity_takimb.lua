...
self.Entity:SetColor(Color(0,104,255,3))
...
SetGlobalInt( "kirmizitakim", GetGlobalInt("kirmizitakim", 0)+(self.puan or 10))
entity:SetPos(topspawnla)
for k, ply in pairs( player.GetAll() ) do
ply:SendLua('chat.AddText( Color( 100, 255, 100 ), "TAKIM B SAYI YAPTI!", Color( 100, 100, 255 )," Tebrikler!" )')
